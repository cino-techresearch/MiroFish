...
class RetryableAPIClient:
    ...
    def call_batch_with_retry(
        ...
        """
        Process a batch of items, retrying each failing item individually.

        Args:
            items: List of items to process
            process_func: Processing function that accepts a single item
            exceptions: Exception types that trigger a retry
            continue_on_failure: Whether to continue processing remaining items after a single-item failure
