    ...
    <div class="main-content">
      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <!-- Simulation workflow steps (new section) -->
...
// Computed: whether the form can be submitted (FR-008)
// - ontology inject: graph_id required (no document needed)
// - ontology generate: document file required
// - profile inject: profileFile also required (so inject intent is reflected at the gate)
...
const startSimulation = () => {
  ...
  // Store pending upload data + injection config
  import('../store/pendingUpload.js').then(({ setPendingUpload }) => {
    setPendingUpload(files.value, formData.value.simulationRequirement, injectionConfig.value)

    // Navigate immediately to the Process page (special marker for new project)
    router.push({
      name: 'Process',
...
:root {
  ...
  --border: #E5E5E5;
  /*
    Use Space Grotesk as the primary heading font and JetBrains Mono for code/labels.
