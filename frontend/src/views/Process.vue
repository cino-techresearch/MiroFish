...
const loadProject = async () => {
  try {
    ...
    if (response.success) {
      ...
      // Resume polling for in-progress build task
...
const renderGraph = () => {
  ...
  // Draw edges (with a wider transparent hit area for clicking)
  ...
  simulation.on('tick', () => {
    // Update all edge positions (both visible line and transparent hit area)
